<template>
  <div class="flex">
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">Charlene Caasi</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-9 w-9" src="https://scontent.fmnl17-4.fna.fbcdn.net/v/t1.0-9/61069870_1205113489667975_3750487772125724672_o.jpg?_nc_cat=105&ccb=1-3&_nc_sid=174925&_nc_eui2=AeFZ8J0k7ZGG3Aght3WiXolGUt3bSi8zxuJS3dtKLzPG4sgFzc1Fj-ToLvPySFoDNZhyHnSVPu5cNZ7D_ulBO9lK&_nc_ohc=QoiXT_FEz5gAX_WvKVE&_nc_ht=scontent.fmnl17-4.fna&oh=fa01a9bd07c8bea910a89e0ab0a12f07&oe=6082BD13" alt="avatar">
                <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Charlene Caasi</h4>
            </div>
        </div>
    </div>
    ...
    <nav class="bg-white shadow dark:bg-gray-800">
        <div class="container px-6 py-3 mx-auto md:flex">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-xl font-bold text-gray-800 dark:text-white md:text-2xl hover:text-gray-700 dark:hover:text-gray-300" href="#" img src="">Charlene's</a>
                </div>
